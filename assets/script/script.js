window.onload = function () {
    ...
    if (document.forms['fileform'] !== undefined) {
        document.forms['fileform'].onsubmit = function () {
            var file = document.querySelector('#userfile').value;
            if (file.length == 0) {
                blockErrors.innerHTML = "Please enter a file";
                return false;
            }
        }
    }
    if (document.forms['groupeform'] !== undefined) {
